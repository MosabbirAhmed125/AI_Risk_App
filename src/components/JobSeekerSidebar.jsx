...
const navItems = [
	{ label: "Home", icon: Home, path: "/job-seeker-home" },
	{
		label: "Dashboard",
		icon: LayoutDashboard,
		path: "/job-seeker-dashboard",
	},
	{ label: "My Skills", icon: Zap, path: "/my-skills" },
	{ label: "Job Sectors", icon: BriefcaseBusiness, path: "/job-sectors" },
	{ label: "Recommendations", icon: CheckCircle, path: "/recommendations" },
];

const bottomItems = [
	{ label: "Profile", icon: User, path: "/job-seeker-profile" },
];
	...
	return (
		<button
			...
			className={`
                ...
                ${
					active
						? "bg-aqua-island-500 text-shark-200"
						: "hover:bg-aqua-island-500"
				}
			...
			<Icon
				...
				className={`
                    ...
                    ${
						active
							? "text-shark-200"
							: "text-aqua-island-500 group-hover:text-shark-200"
					}
                `}
			/>
			{!collapsed && (
				...
				{!collapsed && (
					<motion.div
						...
						className="
                            ...
                            rounded-full bg-aqua-island-500 blur-xl z-0
                        "
					/>
				)}
			</AnimatePresence>
			...
			>
				...
				>
					...
					<button
						...
						className="w-9 h-9 shrink-0 bg-aqua-island-500 rounded-lg flex items-center justify-center hover:opacity-80 transition-opacity"
					>
						<ChevronLeft
							size={17}
							strokeWidth={2.5}
