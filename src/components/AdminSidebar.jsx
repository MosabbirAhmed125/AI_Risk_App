	...
	return (
		<button
			...
			className={`
                ...
                ${
					active
						? "bg-lightning-yellow-600 text-shark-200"
						: "hover:bg-lightning-yellow-600"
				}
			...
			<Icon
				...
				className={`
                    ...
                    ${
						active
							? "text-shark-200"
							: "text-lightning-yellow-600 group-hover:text-shark-200"
					}
                `}
			/>
			{!collapsed && (
				...
				{!collapsed && (
					<motion.div
						...
						className="
                            ...
                            rounded-full bg-lightning-yellow-600 blur-xl z-0
                        "
					/>
				)}
			</AnimatePresence>
				...
				>
					{!collapsed && (
						<div className="flex items-center gap-3 overflow-hidden">
							<div className="relative w-9 h-9 shrink-0 bg-lightning-yellow-600 rounded-lg flex items-center justify-center">
								<BrainCircuit
									size={25}
									strokeWidth={2}
					...
					<button
						...
						className="w-9 h-9 shrink-0 bg-lightning-yellow-600 rounded-lg flex items-center justify-center hover:opacity-80 transition-opacity"
					>
						<ChevronLeft
							size={17}
							strokeWidth={2.5}
