		...
		>
			...
			>
				...
				<motion.p
					...
					className="mt-6 text-base md:text-lg font-ubuntu tracking-[0.25em] uppercase text-aqua-island-500/90"
				>
				...
				<motion.div
					...
					className="mt-8 h-px w-32 bg-linear-to-r from-transparent via-aqua-island-500/60 to-transparent"
				/>
			</motion.div>
		</motion.div>
	);
