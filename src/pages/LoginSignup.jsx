...
export default function LoginSignup() {
	...
	return (
		<div
			className="min-h-screen w-full bg-no-repeat font-ubuntu font-bold flex items-center justify-center px-4 relative overflow-hidden"
			style={{ backgroundColor: "var(--color-shark-950, #0a0a0a)" }}
		>
			<motion.div
				initial={false}
				...
				style={{
					backgroundImage: `radial-gradient(circle at 0% 0%, rgba(214, 44, 57, 0.45), transparent 40%), radial-gradient(circle at 100% 100%, rgba(64, 150, 154, 0.38), transparent 40%)`,
					width: "100%",
					height: "100%",
				}}
			/>
			<motion.div
				...
				className="pointer-events-none absolute inset-0 z-0"
				style={{
					backgroundImage: `radial-gradient(circle at 100% 100%, rgba(214, 44, 57, 0.45), transparent 40%), radial-gradient(circle at 0% 0%, rgba(64, 150, 154, 0.38), transparent 40%)`,
					width: "100%",
					height: "100%",
				}}
			/>
			<motion.div className="relative z-10 w-full flex items-center justify-center">
				<motion.div
